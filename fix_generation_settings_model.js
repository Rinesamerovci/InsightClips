...
const search = /class GenerationSettings\(BaseModel\):[\s\S]*?class GenerationSettingsInput\(BaseModel\):/s;
if (!search.test(content)) {
  throw new Error('Missing GenerationSettings block');
}
const replacement = `class GenerationSettings(BaseModel):
