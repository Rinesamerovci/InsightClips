...
export function ClipsPageContent({ mode = "results" }: ClipsPageContentProps = {}) {
  ...
  const [generationTemplateId, setGenerationTemplateId] =
    useState<GenerationTemplateId | undefined>("hook_spotlight");
  ...
  useEffect(() => {
    generationTemplateIdRef.current = generationTemplateId ?? "hook_spotlight";
  ...
  useEffect(() => {
    ...
    saveGenerationPreferences(generationTemplateId ?? "hook_spotlight", generationSettings);
